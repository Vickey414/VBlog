  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-bottom: 20px;">
    <div class="container">
      <router-link to="/" class="navbar-brand">
        <img src="Vblog/front-end/img/V-logo.svg" width="30" height="30" class="d-inline-block align-top" alt="">
          Vblog
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul v-if="sharedState.is_authenticated" class="nav navbar-nav navbar-right">
          ...
          <li class="nav-item">
            v-bind:to="{ name: 'Profile', params: { id: sharedState.user_id }}" class="nav-link">Profile</router-link>
          </li>
          <li class="nav-item">
...
//使用了<router-link to="/login" class="nav-link">Login</router-link>形式来导航到登陆界面
